                  ...
                  return (
                    <tr key={hyp.id} className="hover:bg-slate-900/50">
                      ...
                      <td className="py-3.5 px-3 text-slate-400 font-mono text-[11px]">
                        <span className="text-emerald-400">${Number(hyp.target_price).toFixed(2)}</span> /{" "}
                        <span className="text-red-400">${Number(hyp.stop_loss_price).toFixed(2)}</span>
                      </td>
